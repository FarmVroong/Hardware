...
if("TRUE" STREQUAL "TRUE")
  set(i2cpwm_board_SOURCE_PREFIX /home/jetson/catkin_ws/src/ros-i2cpwmboard)
  set(i2cpwm_board_DEVEL_PREFIX /home/jetson/catkin_ws/devel)
  ...
  set(i2cpwm_board_INSTALL_PREFIX /home/jetson/catkin_ws/install)
...
if(NOT "/home/jetson/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'i2cpwm_board' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetson/catkin_ws/src/ros-i2cpwmboard/${idir}'.  ${_report}")
    endif()
